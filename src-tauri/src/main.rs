...
struct TradeTagVisibilitySettings {
...
fn default_settings() -> AppSettings {
    AppSettings {
        ...
        brl_to_usd_rate: 0.0,
        brl_ticker_list: "BBAS3, ITSA4, BBDC4, VALE3, ASAI3, CEAB3, ABEV3, PETR4, PRIO3, CSAN3, BRAV3, RECV3, COGN3, AMBP3, GGPS3, WEGE3, EMBJ3, HAPV3".to_string(),
